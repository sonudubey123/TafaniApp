package com.sunmi.tafani_printerhelper.nextgen_sharique.transaction_history.retailer;
...
import com.sunmi.tafani_printerhelper.nextgen_sharique.modal.TransactionHistoryRetModal;
import com.sunmi.tafani_printerhelper.utils.BluetoothUtil;
import com.sunmi.tafani_printerhelper.utils.SunmiPrintHelper;


public class TransactionDetailsRetRecycleView extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            if (languageToUse.trim().length() == 0) {
                ...
                languageToUse = "ar";
                LocalSetLanguage.LocalSet(languageToUse, TransactionDetailsRetRecycleView.this);
            }
            else
            {
                LocalSetLanguage.LocalSet(languageToUse,TransactionDetailsRetRecycleView.this);
            ...
            setContentView(R.layout.transhistory_ret_recycleview);
            ...
            String TRANSACTION_HISTORY_RET_API= MyApplication.getSaveString("TRANSACTION_HISTORY_RET_API",TransactionDetailsRetRecycleView.this);
            ...
            recycler_view.setLayoutManager(new LinearLayoutManager(TransactionDetailsRetRecycleView.this));

            TransactionHistoryRetAdapter recyclerViewAdapter = new TransactionHistoryRetAdapter(TransactionDetailsRetRecycleView.this,arrayList_transactionHistoryRet);
        ...
        {
            Toast.makeText(TransactionDetailsRetRecycleView.this,e.toString(),Toast.LENGTH_LONG).show();
            e.printStackTrace();
        }
