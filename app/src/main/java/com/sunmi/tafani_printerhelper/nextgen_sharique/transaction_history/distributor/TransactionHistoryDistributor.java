package com.sunmi.tafani_printerhelper.nextgen_sharique.transaction_history.distributor;
...
import static com.sunmi.tafani_printerhelper.nextgen_sharique.voly_url.Url.login_ret_transactiionHistory_apinname;
...
public class TransactionHistoryDistributor extends AppCompatActivity implements View.OnClickListener, InterHttpServerResponse {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            if (languageToUse.trim().length() == 0) {
                ...
                languageToUse = "ar";
                LocalSetLanguage.LocalSet(languageToUse, TransactionHistoryDistributor.this);
            }
            else
            {
                LocalSetLanguage.LocalSet(languageToUse,TransactionHistoryDistributor.this);
            ...
            setContentView(R.layout.transhistory_distributor);
        ...
        {
            Toast.makeText(TransactionHistoryDistributor.this,e.toString(),Toast.LENGTH_LONG).show();
            e.printStackTrace();
        }
    ...
    protected void alertbox(String mymessage,String heading, Context context)
    {
        ...
        try {
            ...
            if (mymessage.equalsIgnoreCase("Invalid PIN")) {
                ...
                Toast.makeText(TransactionHistoryDistributor.this,getString(R.string.invalid_pin), Toast.LENGTH_SHORT).show();

            } else if ((mymessage.equalsIgnoreCase("Subscriber Blocked"))) {

                Toast.makeText(TransactionHistoryDistributor.this,getString(R.string.subscriber_blocked), Toast.LENGTH_SHORT).show();

            }

            else if ((mymessage.equalsIgnoreCase("Agent Blocked"))) {

                Toast.makeText(TransactionHistoryDistributor.this,getString(R.string.agent_bloack), Toast.LENGTH_SHORT).show();

            }

           else if ((mymessage.equalsIgnoreCase("Subscriber/Agent Blocked"))) {

                Toast.makeText(TransactionHistoryDistributor.this,getString(R.string.subscriber_agent_blocked), Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(TransactionHistoryDistributor.this,getString(R.string.insuffience_fund), Toast.LENGTH_SHORT).show();
            }

            else if ((mymessage.equalsIgnoreCase("Insufficient Wallet"))) {

                Toast.makeText(TransactionHistoryDistributor.this,getString(R.string.insuffience_wallet), Toast.LENGTH_SHORT).show();

            }

            else if ((mymessage.equalsIgnoreCase("Records Not found"))) {

                Toast.makeText(TransactionHistoryDistributor.this,getString(R.string.record_not_found), Toast.LENGTH_SHORT).show();

            }

            else {

                Toast.makeText(TransactionHistoryDistributor.this,mymessage, Toast.LENGTH_SHORT).show();

            }
        }
        catch (Exception e)
        {
            Toast.makeText(TransactionHistoryDistributor.this,e.toString(), Toast.LENGTH_SHORT).show();
        ...
        switch (view.getId()) {
            case R.id.imageButton1:
                if (checkValidation()) {
                    ...
                    if (CommonUtility.isOnline(TransactionHistoryDistributor.this)) {

                        //  serverRequest(4);

                        try {

                            CommonUtility.showProgressDialog(TransactionHistoryDistributor.this);
                            ...
                            CommonUtility.hideProgressDialog(TransactionHistoryDistributor.this);
...
//                break;
    ...
    private boolean checkValidation() {
        ...
        if (mpinString.isEmpty()) {
            Toast.makeText(TransactionHistoryDistributor.this, getResources().getString(R.string.enter_mpin), Toast.LENGTH_SHORT).show();
            return false;
        }
...
*/
        ...
        try {
            ...
            new VollyRequestResponse(TransactionHistoryDistributor.this, TransactionHistoryDistributor.this, requestNo, base_url+login_ret_transactiionHistory_apinname, json_main.toString());
    ...
    private void showAlertDialog(String msg, final int requestId) {
        AlertDialog.Builder builder = new AlertDialog.Builder(TransactionHistoryDistributor.this);
                        ...
                        if (jsonObject_response.has("resultcode")) {
                            ...
                            if (resultcode.equalsIgnoreCase("0")) {
                               ...
                               // Toast.makeText(this, amount, Toast.LENGTH_SHORT).show();
                                ...
                                MyApplication.saveString("TRANSACTION_HISTORY_DES_API",serverResponse.toString(), TransactionHistoryDistributor.this);


                                Intent intent = new Intent(TransactionHistoryDistributor.this, TransactionDetailsDistributorRetRecycleView.class);  // temporary
                                ...
                                alertbox(resultdescription,getString(R.string.transaction_result), TransactionHistoryDistributor.this);
