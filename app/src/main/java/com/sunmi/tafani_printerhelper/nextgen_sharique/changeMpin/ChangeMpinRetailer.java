package com.sunmi.tafani_printerhelper.nextgen_sharique.changeMpin;
...
public class ChangeMpinRetailer extends AppCompatActivity implements View.OnClickListener, InterHttpServerResponse {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            if (languageToUse.trim().length() == 0) {
                ...
                languageToUse = "ar";
                LocalSetLanguage.LocalSet(languageToUse, ChangeMpinRetailer.this);
            }
            else
            {
                LocalSetLanguage.LocalSet(languageToUse,ChangeMpinRetailer.this);
            ...
            setContentView(R.layout.change_mpin_ret);
        ...
        {
            Toast.makeText(ChangeMpinRetailer.this,e.toString(),Toast.LENGTH_LONG).show();
            e.printStackTrace();
        }
    ...
    protected void successResponse()
    {
        ...
        dialog = new Dialog(ChangeMpinRetailer.this);
        ...
        dialogbutton1.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                ChangeMpinRetailer.this.finish();
        ...
        switch (view.getId()) {
            ...
            case R.id.imageButton1:
                ...
                if (validation_Details()) {
                    ...
                    if (CommonUtility.isOnline(ChangeMpinRetailer.this)) {

                        //  serverRequest(4);

                        try {

                            CommonUtility.showProgressDialog(ChangeMpinRetailer.this);
                            ...
                            CommonUtility.hideProgressDialog(ChangeMpinRetailer.this);

                            Toast.makeText(ChangeMpinRetailer.this, e.toString(), Toast.LENGTH_SHORT).show();
                            e.printStackTrace();
                        }
...
//                break;
    ...
    boolean validation_Details()
    {
        ...
        if(oldPinStr.isEmpty()) {
            ...
            Toast.makeText(ChangeMpinRetailer.this,getString(R.string.plz_enter_old_pin), Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(ChangeMpinRetailer.this,getString(R.string.plz_enter_new_pin), Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(ChangeMpinRetailer.this,getString(R.string.plz_confirm_new_pin), Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(ChangeMpinRetailer.this,getString(R.string.new_coinfirm_should_be_same), Toast.LENGTH_SHORT).show();
...
/*        {
        ...
        try {
            ...
            jsonObject_request.put("source",MyApplication.getSaveString("mobileNoString", ChangeMpinRetailer.this));
            ...
            new VollyRequestResponse(ChangeMpinRetailer.this, ChangeMpinRetailer.this, requestNo, base_url+login_ret_changeMpin_apinname, json_main.toString());
    ...
    private void showAlertDialog(String msg, final int requestId) {
        AlertDialog.Builder builder = new AlertDialog.Builder(ChangeMpinRetailer.this);
