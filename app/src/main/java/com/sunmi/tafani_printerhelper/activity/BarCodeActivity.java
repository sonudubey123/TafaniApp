package com.sunmi.tafani_printerhelper.activity;
...
import com.sunmi.tafani_printerhelper.utils.ESCUtil;
...
public class BarCodeActivity extends BaseActivity {
    ...
    public void onClick(View view) {
        ...
        Bitmap bitmap = com.sunmi.tafani_printerhelper.utils.BitmapUtil.generateBitmap(text, symbology, 700, 400);
        if (bitmap != null) {
