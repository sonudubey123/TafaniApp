package com.sunmi.tafani_printerhelper.nextgen_sharique.database.offline;
...
@Database(entities = {ProductOfflineModel.class, OperatorOfflineModel.class,PrintfOfflineModal.class, BulkDownloadOfflineModel.class, ServiceOperatorDownloadOfflineModel.class, ServiceProductDownloadOfflineModel.class, PosstockODownloadOfflineModel.class, PostockSDownloadOfflineModel.class}, version = 5)
