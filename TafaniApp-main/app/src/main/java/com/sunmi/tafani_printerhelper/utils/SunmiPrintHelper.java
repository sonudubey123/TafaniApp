package com.sunmi.tafani_printerhelper.utils;
...
public class SunmiPrintHelper {
    ...
    public void setAlign_nextgen(int align){
        if(sunmiPrinterService == null){
            //TODO Service disconnection processing
            return;
        }
    ...
    // 0 left --- 1---centre-----2----left

    public void printBitmap_nextgen(Bitmap bitmap,int align) {

        setAlign_nextgen(align);
    ...
    public void printBitmap_nextgen_align(int align){
        if(sunmiPrinterService == null){
            //TODO Service disconnection processing
            return;
        }
